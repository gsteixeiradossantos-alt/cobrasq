...
**Aplicada em produção em 24/09/2026** (com `SET search_path TO 'public'`, que a função já tinha). Depende de `20260924c_cobrancas_etapa_trigger`. Só `CREATE OR REPLACE`
